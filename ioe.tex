...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\end{enumerate}
			\item Ergibt ein gemeinsames Aggregat. Funktioniert da sich die Zufallszahlen gegenseitig egalisieren. Allerdings kann MDL die Werte einzelner Zähler nicht nachvollziehen, da er die Zufallswerte nicht kennt
