...
\begin{itemize}
	...
	\begin{itemize}
		\item Magnetic Tunnel Junction (MTJ): Ausrichtung einer Magnetische Schicht in einem magnetischen Tunnel kann mit einem drehpolarisierten Strom festgelegt werden
	...
	\begin{itemize}
		\item Wirkprinzip: Die Änderung des elektrischen Widerstandes des Speichermaterials in Abhängigkeit davon, ob es in amorpher (hoher Widerstand / RESET state) oder in kristalliner (niedriger Widerstand / SET state) Phase vorliegt\footnote{\url{https://de.wikipedia.org/wiki/Phase-change_random_access_memory}}
