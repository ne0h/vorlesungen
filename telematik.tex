...
\begin{itemize}
	...
	\begin{description}
		...
		\item{E-Kanal}: Medienzugriff (CS, CD) NT zu Endsystem bei 16 kbit/s; Unterstützung des konkurrierenden Medienzugriffs auf D-Kanal (NT refkletiert D-Kanal in E-Kanal im ankommenden \(S_0\)-Rahmen)
	\end{description} 
\end{itemize}
