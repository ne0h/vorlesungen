...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Gewinn/Verlust: \(GV(T)=P(T)-P(0) = max(X-S(T),0)-P(T)\)
			\item Gewinn/Verlust, inklusive Zinsen: \(GV(T)=P(T)-P(0) = max(X-S(T),0)-P(T) \cdot (1+r)^T\)
		\end{itemize}
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item Klassische Analyse von Optionspositionen anhand von Gewinn- und Verlust-Diagrammen
\end{itemize}
