...
\end{algorithm}
\textit{Wanze} terminiert, da \(R\) das Ziel spätestens dann findet, wenn er alle \(P_i\) maximal einmal umlaufen hat.
...
Schema-Theorem: Merkmale werden häufiger reproduziert, wenn sie 
\begin{enumerate}
