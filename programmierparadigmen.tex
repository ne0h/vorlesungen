...
\begin{itemize}
	\item Der globale Adressebereich im Arbeitsspeicher wird unterteilt und jeder Prozessor bekommt einen Teil davon zugewiesen (trotzdem kann immer auf alle Speicherbereiche zugegriffen werden)
	\item 
\end{itemize}
