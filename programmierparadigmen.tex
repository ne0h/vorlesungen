...
\begin{itemize}
	...
	\end{enumerate}
	\item Anschließend: Ersetzen der Nichtterminale durch Terminale
\end{itemize}
...
\begin{tabularx}{\textwidth}{l|X|X}
	...
	\textbf{elem} & \(Eq~a \Rightarrow a \rightarrow [a] \rightarrow Bool\) & Prüft, ob ein Element in einer Liste vorhanden ist \\
