...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Analytische Methoden versuchen mathematische Beziehungen zwischen Leistungsgrößen herzuleiten. Oft minimaler Aufwand aber auch nur minimal aussagekräftig (beispielsweise Warteschlangenmodelle oder Petrinetze)
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item Beispiel: Omega-Netz, bestehend aus \(\frac{N\cdot log_k(N)}{k}\) Crossbars bei \(N\) Knoten mit Switch-Grad \(k\). Nicht blockierungsfrei
		\end{itemize}
	\end{itemize}
\end{itemize}
