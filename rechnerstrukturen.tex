...
\subsection{Einführung}
\begin{itemize}
	\item Verarbeitungsbeispiel: \(Y = a \cdot X + Y\)
	\item Bei normalen Prozessoren hoher Aufwand durch viele Schleifendurchläufe, Pipeline-Konflikte oder Mehrzuklusoperationen
	\item Vektor-Prozessor verwendet SIMD-Verarbeitung (Single Instruction Multiple Data). Verarbeitung in einem Rechenwerk mit pipeline-artig aufgebauten Funktionseinheiten
	\item \textbf{Aufbau eines Vektorprozessors}
	\begin{itemize}
		\item Ladeeinheit für Vektoren direkt am Hauptspeicher
